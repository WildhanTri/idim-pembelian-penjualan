                ...
                <tr>
                    ...
                    <td>
                        <div class="clm-6 np-y" style="padding-right:0px;">
                            <a href="submit.php?barang-edit=<?php echo $barang['id_barang'] ?>"><button class="btn btn-orange">Edit</button></a>
                        </div>
                        <div class="clm-6 np-y">
                            <a href="submit.php?barang-delete=<?php echo $barang['id_barang'] ?>"><button class="btn btn-red">Hapus</button></a>
                        </div>
                    </td>
                </tr>
                <?php endforeach ?>
